...
namespace Ebd.Infra.Data.Extensions
{
    public static class DbContextExtension
    {
        ...
        private static void ConvertToSnake(INpgsqlNameTranslator mapper, object entity)
        {
            ...
            //         relationalTable.TableName = ModifyNameBeforeConvertion(mapper, relationalTable.TableName);
            //         break;
            //     case IMutableProperty property:
            //         property.Relational().ColumnName = ModifyNameBeforeConvertion(mapper, property.Relational().ColumnName);
            //         break;
